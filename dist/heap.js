...
exports.Heap_small_root = exports.Heap_big_root = void 0;
class Heap_big_root {
    #depth;
    #heap = []; // 大 - 小
    /**
     ...
     * @param depth 最大容量
     */
    constructor(nums, depth = Infinity) {
        if (depth <= 0)
            throw new Error('think twice before you act!');
    ...
    delete() {
        if (this.size <= 2) {
            ...
            while (largeChildIdx < this.size) {
                if (this.#heap[p] >= this.#heap[largeChildIdx])
                    return head;
                else {
...
exports.Heap_big_root = Heap_big_root;
    ...
    delete() {
        if (this.size <= 2) {
            ...
            while (smallChildIdx < this.size) {
                if (this.#heap[p] <= this.#heap[smallChildIdx])
                    return head;
                else {
...
exports.Heap_small_root = Heap_small_root;
